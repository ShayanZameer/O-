...
//     try {
//       const response = await axios.post(`${config.REACT_APP_BACKEND_URL}/api/medicine/donate-medicine`, {
...
//       // Reset form data if the submission was successful
//       setFormData({
//         donorName: '',
//         medicineName: '',
//         quantity: '',
...
function DonateMedicine() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Optional: Show a success message or popup
      setShowPopup(true);
